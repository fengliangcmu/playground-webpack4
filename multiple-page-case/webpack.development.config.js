...
// const UglifyJSPlugin = require('uglifyjs-webpack-plugin');  no need for dev mode
// const MiniCssExtractPlugin = require('mini-css-extract-plugin'); no need for dev mode
...
module.exports = {
        ...
        rules:[
            ...
            },
            {
                ...
                use: [
                    ...
                    //MiniCssExtractPlugin.loader, 'css-loader' no need for dev mode
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            ...
            chunks: ['hello-world'], //as names in entry point config
            title: 'helloworld',
            template: 'src/page-template.hbs'
        }),
        new HtmlWebpackPlugin({
            filename: 'kiwi.html',
            chunks: ['kiwi'], // no need for vendor~ thing
            title: 'kiwi',
            template: 'src/page-template.hbs'
        })
    ]
